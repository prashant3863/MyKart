...
public class ProductCategoriesListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view;
        if (convertView == null) {
            view = this.layoutInflator.inflate(R.layout.product_category_list_item, parent, false);
        } else {
            view = convertView;
        }
        TextView productCategoryName = (TextView) view.findViewById(R.id.product_category_list_item_text);
